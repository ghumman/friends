...
public class MessageController {
    ...
    public ResponseEntity<MessageResponse> sendMessage(@RequestParam String message,
            @RequestParam String messageFromEmail, @RequestParam String messageToEmail, @RequestParam String authType,
        ...
        try {
            ...
            if (sendUser == null) {
                ...
                messageResponse.setTime(new Date(System.currentTimeMillis()));
            ...
            if (user == null) {
                ...
                if (authType.equals(AuthType.regular.toString())) {
                    ...
                    if(passwordMatch) 
                    {
                        ...
                        List<Message> msgs = messageRepository.findAllByMessageToAndMessageFromOrMessageToAndMessageFrom(user, friend, friend, user);
