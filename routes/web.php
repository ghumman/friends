        ...
        if ($email != null && $password != null) {
            ...
            try {
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    $temp = generateKey($password, $results[0]['salt']);
...
Route::post('all-friends', function (Request $request) {
...
Route::post('messages-user-and-friend', function (Request $request) {
...
function connectToDatabase() {
    try {
        ...
        $conn = new PDO("mysql:host=localhost;dbname=friends_mysql", "ghumman", "ghumman");
        return $conn;
    } catch (PDOException $e) {
        $conn = null;
        return $conn;
